...
جهت دریافت توکن، ابتدا وارد اکانت والکس شوید. سپس از طریق حساب کاربری وارد بخش تنظیمات شوید. در بخش تنظیمات، در بخش مدیریت APIها می‌توانید اقدام به دریافت توکن کنید.
